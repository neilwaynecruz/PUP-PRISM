...
defineOptions({
    name: 'AdminOriginsIndex',
    layout: {
        breadcrumbs: [
            { title: 'Admin', href: index() },
            { title: 'Origins', href: index() },
        ],
    },
});
    ...
    >
        ...
        >
            <Heading
                variant="small"
                title="Origins"
                description="Product origin reference data."
            />
            <Button
                v-if="can.create"
                as-child
        ...
        <AdminTableShell min-width="820px">
            <colgroup>
                <col class="w-[48%]" />
                <col class="w-[18%]" />
                <col class="w-[22%]" />
            ...
            <tbody class="divide-y divide-border/60">
                ...
                >
                    ...
                    <td class="text-center">
                        <AdminCountBadge :value="row.products_count" />
                    </td>
                    <td>
        ...
        <AdminPagination :links="origins.links" />
    </div>
</template>
