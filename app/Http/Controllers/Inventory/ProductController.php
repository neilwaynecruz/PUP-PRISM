...
class ProductController extends Controller
{
    ...
    public function show(Request $request, DemandForecaster $forecaster, ForecastPresenter $presenter, int $productId): Response|SymfonyResponse
    {
        ...
        if ($product->type === ProductType::Consumable) {
            ...
            if (
                ...
                && $presenter->isSnapshotFromToday($latestSnapshot)
            ) {
                $forecast = $presenter->fromSnapshot($latestSnapshot);
            } else {
                $forecast = $presenter->fromResult(
